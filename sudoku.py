...
def test_carrés(grille: list) -> bool:
    """teste si chaque carré est correctement rempli
    (chaque chiffre entre 1 et 9 est présent une fois)
...
def verification(grille: list) -> bool:
    """vérifie si une grille de sudoku est correctement remplie
    (si chaque chiffre entre 1 et 9 est présent exactement une fois
